...
<div align="center">
	...
	<table align="center" width="80%" border="0" cellspacing="0" cellpadding="3">
		...
		<tr>
			...
			int pageEnd = ((pageStart + pagePerBlock) < totalPage) ? (pageStart): totalPage + 1;	//하단 페이지 끝 번호
	...
	<hr width="80%">
	<form action="list.jsp" name="searchFrm" method="post">
	...
	<form name="listFrm" method="post">
		<input type="hidden" name="num" value="true">
		<input type="hidden" name="nowPage" value="1">
	</form>
